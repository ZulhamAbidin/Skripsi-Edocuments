...
<body>
    <div class="isolate bg-white sm:py-32 md:py-0 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center mt-6 md:mt-10">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl px-2">LOGIN PESERTA PENGESAHAN</h2>
            <p class="mt-2 text-sm leading-8 text-gray-600 px-10 md:px-0">Dinas Ketenagakerjaan Bidang Penempatan Tenaga
                Kerja Dan Perluasan Kesempatan Kerja.</p>
        </div>

        <form method="POST" action="{{ route('login') }}"
            class="mx-auto lg:mt-1 max-w-xl sm:py-32 md:py-14 lg:py-7 lg:px-8 px-10">
            @csrf
