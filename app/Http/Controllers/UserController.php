    ...
    public function index(Request $request)
{
    ...
    $totalTime = $end - $start;
     ...
     return view('management.index', compact('data', 'totalTime'));
}
  ...
  public function search(Request $request)
{
    ...
    $message = $data->isEmpty() ? 'Tidak ada data yang ditemukan.' : '';

    return view('management.index', compact('data', 'message'));
}
