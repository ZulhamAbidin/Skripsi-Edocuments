    ...
    <div class="isolate bg-white sm:py-3 md:py-0 lg:px-8">
        ...
        <form method="POST" action="{{ route('login') }}"   class="mx-auto lg:mt-1 max-w-lg sm:py-32 md:py-14 lg:py-7 lg:px-8 px-10">
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-2.5">
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                            ...
                            class="focus:outline-none focus:border-[#B50104] focus:ring-1 focus:ring-[#B50104] block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  focus:ring-inset  sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    <button type="submit"
                        class="block w-full rounded-md bg-[#B50104] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#B50104] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B50104]">Submit</button>
                </div>
...
<script>
    function togglePasswordVisibility() {
            ...
            if (passwordInput.type === 'password') {
                ...
                eyeIcon.classList.add('text-[#B50104]');
            } else {
                passwordInput.type = 'password';
                eyeIcon.classList.remove('text-[#B50104]');
