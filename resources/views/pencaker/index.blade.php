        ...
        <header class="absolute inset-x-0 top-0 z-40">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="flex gap-x-6">
                    <a href="/profile"
                        class="rounded-md mobile-menu-button bg-[#B50104] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#C50009] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B50104]">
                        Profile
                    </a>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl pt-10">
                <div class="sm:mb-8 sm:flex sm:justify-center">
                    <div
                        class="relative text-center my-6 py-2 rounded-full px-3 lg:py-1 capitalize text-[#B50104] text-sm leading-6  ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <button type="button" class="rounded-md mobile-menu-button bg-[#B50104] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#C50009] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B50104]">
                            Tambah Data Pengesahan</button>
                    </div>
                    <div class="mt-2 flex items-center justify-center gap-x-6">
                        <a href="https://bit.ly/kusioner-edocument" target="blank"
                            class="rounded-md mobile-menu-button bg-[#B50104] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#C50009] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B50104]">
                            Isi Kusioner</a>
                    </div>
                </div>
                            ...
                            <div class="mt-10 w-full md:max-w-lg">
                                <form action="{{ route('pencaker.store') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input value="" id="NamaLengkap" name="NamaLengkap"
                                            type="text" autocomplete="NamaLengkap" required
                                            class="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="NoRegistrasi" class="block pb-1 text-sm font-medium text-gray-900">No Registrasi</label>
                                        <input value="" placeholder="Contoh 0000-00000000-000000" id="NoRegistrasi" name="NoRegistrasi" type="text" autocomplete="NoRegistrasi" required
                                            class="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]" required>
                                        <small>No Pendaftaran Para Pencari Kerja</small>
                                    </div>

                                    <div class="mb-4">
                                        <label for="TujuanPerusahaan" class="block pb-1 text-sm font-medium text-gray-900">Tujuan Perusahaan</label>
                                        <input value="" id="TujuanPerusahaan" name="TujuanPerusahaan" type="text" autocomplete="TujuanPerusahaan" required
                                            class="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="AlamatDomisili" class="block text-sm pb-1 font-medium text-gray-900">Alamat Domisili</label>
                                        <select id="AlamatDomisili" name="AlamatDomisili" required
                                            class="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]">
                                    ...
                                    <div class="mb-4">
                                        <label for="TujuanPerusahaan" class="block pb-1 text-sm font-medium text-gray-900">Tempat Tanggal Lahir</label>
                                        <input value="" id="TempatTanggalLahir" name="TempatTanggalLahir" type="text" autocomplete="TempatTanggalLahir"  class="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="JenisKelamin" name="JenisKelamin" required
                                            class="block w-full px-3 py-2 border capitalize border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]">
                                    ...
                                    <div class="mb-4">
                                        <label for="NoTelfon" class="block text-sm pb-1 font-medium text-gray-900">No
                                            Ponsel</label>
                                        <input value="" id="NoTelfon" name="NoTelfon" type="number"
                                            autocomplete="NoTelfon" required
                                            class="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]">
                                        @error('NoTelfon')
                                    ...
                                    <div class="mb-4">
                                        <label for="StatusPerkawinan" class="block pb-1 text-sm font-medium text-gray-900">Status Perkawinan</label>
                                        <select id="StatusPerkawinan" name="StatusPerkawinan" class="block w-full px-3 py-2 border capitalize border-gray-300 rounded-md focus:outline-none focus:border-[#C50009] focus:ring-[#C50009]" required>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input value="" id="Jurusan" name="Jurusan"
                                    ...
                                    <div class="mb-4">
                                        <label for="Total"  class="block pb-1 text-sm font-medium text-gray-900">Jumlah Yang Di SAH kan</label>
                                    ...
                                    <div class="flex gap-x-2 mb-10 mt-5">
                                        ...
                                        <button type="submit"
                                            class="w-full px-3 py-1.5 text-sm font-semibold text-white bg-[#B50104] rounded-md hover:bg-[#C50009] focus:outline-none focus-visible:ring focus-visible:ring-[#C50009] focus-visible:ring-opacity-50">Submit</button>
                                    </div>
