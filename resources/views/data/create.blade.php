                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('data.store') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="NoRegistrasi" id="NoRegistrasi"
                                    class=" form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="TujuanPerusahaan" id="TujuanPerusahaan" class=" form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="TempatTanggalLahir" id="TempatTanggalLahir" class=" form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select name="AlamatDomisili" class="form-control form-select" data-bs-placeholder="Select Alamat Domisili">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select name="JenisKelamin" class="form-control form-select" id="JenisKelamin"
                                    data-bs-placeholder="JenisKelamin">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="NoTelfon" id="NoTelfon"
                                    class="  form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select name="Status" class="form-control form-select" id="Status" data-bs-placeholder="Status">
