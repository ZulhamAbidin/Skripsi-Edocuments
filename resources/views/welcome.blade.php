...
<head>
    ...
    <link href="{{ asset('image/zulham1.css') }}" rel="stylesheet" />
    <link href="{{ asset('image/zulham2.css') }}" rel="stylesheet" />

    <script src="{{ asset('image/zulham3.js') }}"></script>
        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="/login"
                        class="{{ auth()->check() ? 'hidden' : '' }} rounded-md flex bg-[#B50104] px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#B50104] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C50009]">
                        <span>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            ...
                            <div class="space-y-2 py-6">
                                <a
                                    href="#/"class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-[#B50104] hover:text-slate-50">Home</a>
                                <a href="#Experience"
                                    class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-[#B50104] hover:text-slate-50">Masukan<a>
                                        <a href="#Contact"
                                            class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-[#B50104] hover:text-slate-50">Contact</a>
                                        <a href="/login"
                                            class="{{ auth()->check() ? 'hidden' : '' }} -mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-[#B50104] hover:text-slate-50 ">Login</a>
                            </div>
            ...
            <div class="relative z-40 isolate px-6 lg:px-8 mt-24 md:mt-36">
                ...
                <div class="mx-auto grid grid-cols-7 my-6 md:my-10 px-4 gap-x-8  ">
                    ...
                    <div class="col-span-7 md:col-span-4 text-left">
                        <h1 id="typed-text" class="zulham text-start fw-bold text-[#B50104] font-bold text-3xl"></h1>
                        ...
                        <div class="mt-5 flex items-center md:justify-start gap-x-6">
                            @if (auth()->check())
                                @if (auth()->user()->role_id == 3)
                                    <a href="/pencaker"
                                        class="rounded-md flex bg-[#B50104] px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#C50009] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C50009]">
                                        Dashboard
                                    </a>
                            ...
                            @else
                                <a href="/register"
                                    class="rounded-md flex bg-[#B50104] px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#C50009] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C50009]"><span><svg
                                ...
                                <a href="/login"
                                    class="text-xs font-semibold leading-6 text-gray-900 border rounded-lg px-10 py-1.5 hover:bg-[#B50104] hover:text-white border-gray-300">Login
            ...
            <div class="isolate bg-white px-6 py-24 pb-5 lg:px-8">
                ...
                <div class="mx-auto max-w-2xl text-center">
                 ...
                 <form action="{{ route('saran.store') }}" method="POST" class="mx-auto mt-6 md:20 max-w-xl ">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2.5">
                                <input type="text" name="nama" id="name" autocomplete="name"
                                    class="block w-full text-xs rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C50009] sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2.5">
                                <textarea name="saran" id="message" rows="4"
                                    class="block w-full text-xs rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#C50009] sm:leading-6"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="mt-5">
                        <button type="submit"
                            class="block w-full text-xs rounded-md bg-[#C50009] px-3.5 py-2.5 text-center  font-semibold text-white shadow-sm hover:bg-[#B50104] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C50009]">Let's
                            Submit</button>
                    </div>
                </form> 
