                ...
                <div class="card-body">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class=" row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" readonly="" value="{{ $pengesahan->NoRegistrasi }}">
                                </div>
                            </div>
                            ...
                            <div class=" row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" readonly="" value="{{ $pengesahan->TujuanPerusahaan }}">
                                </div>
                            </div>
                            ...
                            <div class=" row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" readonly="" value="{{ $pengesahan->TempatTanggalLahir }}">
                                </div>
                            </div>
                            ...
                            <div class=" row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" readonly="" value="{{ $pengesahan->StatusPerkawinan }}">
                                </div>
                            </div>
