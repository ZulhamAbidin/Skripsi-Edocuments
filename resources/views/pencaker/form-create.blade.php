                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pencaker.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="NoRegistrasi" id="NoRegistrasi" class="form-control" value="{{ old('NoRegistrasi') }}"
                                required>
                            @error('NoRegistrasi')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            <label for="TujuanPerusahaan">Tujuan Perusahaan</label>
                            <input type="text" name="TujuanPerusahaan" id="TujuanPerusahaan" class="form-control" value="{{ old('TujuanPerusahaan') }}"
                                required>
                            @error('TujuanPerusahaan')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
